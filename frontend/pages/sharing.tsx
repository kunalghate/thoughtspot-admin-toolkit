...
export default function SharingPage() {
  return (
    <AppShell pageTitle="Bulk Sharing">
      <ComingSoon
        icon={<Share2 size={32} style={{ color: "#8B5CF6" }} />}
        title="Bulk Sharing"
        description="Share multiple Liveboards, Answers, and Worksheets with users or groups in a single operation. Set read or edit permissions at scale."
      />
    </AppShell>
  );
}
