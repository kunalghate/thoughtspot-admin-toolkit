...
def archiver_all_records(
    ...
    object_type: str | None = Query(default=None, description="LIVEBOARD or ANSWER"),
    owner_name: str | None = Query(default=None, description="Substring match on owner name"),
    record_offset: int = Query(default=0, ge=0),
    page_size: int = Query(default=200, ge=1, le=1000),
